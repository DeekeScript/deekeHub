...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./var/www/html/php/public/storage' => 'string',
            ...
            'cache.prefix' => 'string',
            'captcha.length' => 'integer',
            'captcha.codeSet' => 'string',
            'captcha.expire' => 'integer',
            'captcha.useZh' => 'boolean',
            'captcha.math' => 'boolean',
            'captcha.useImgBg' => 'boolean',
            'captcha.fontSize' => 'integer',
            'captcha.useCurve' => 'boolean',
            'captcha.useNoise' => 'boolean',
            'captcha.fontttf' => 'string',
            'captcha.bg' => 'array',
            'captcha.imageH' => 'integer',
            'captcha.imageW' => 'integer',
            'console.commands.dke' => 'string',
            'cookie.expire' => 'integer',
            'cookie.path' => 'string',
            'cookie.domain' => 'string',
            'cookie.secure' => 'boolean',
            'cookie.httponly' => 'boolean',
            'cookie.setcookie' => 'boolean',
            ...
            'domain.me.0.domain' => 'string',
            'domain.me.0.weight' => 'integer',
            'domain.me.0.is_notification' => 'boolean',
            'domain.me.1.domain' => 'string',
            'domain.me.1.weight' => 'integer',
            'domain.me.1.is_notification' => 'boolean',
            'domain.me.2.domain' => 'string',
            'domain.me.2.weight' => 'integer',
            'domain.me.2.is_notification' => 'boolean',
            'domain.me.3.domain' => 'string',
            'domain.me.3.weight' => 'integer',
            'domain.me.3.is_notification' => 'boolean',
            'domain.customer.0.domain' => 'string',
            'domain.customer.0.weight' => 'integer',
            'domain.customer.0.is_year' => 'boolean',
            'domain.customer.0.is_notification' => 'boolean',
            'domain.customer.1.domain' => 'string',
            'domain.customer.1.weight' => 'integer',
            'domain.customer.1.is_year' => 'boolean',
            'domain.customer.1.is_notification' => 'boolean',
            'domain.customer.2.domain' => 'string',
            'domain.customer.2.weight' => 'integer',
            'domain.customer.2.is_year' => 'boolean',
            'domain.customer.2.is_notification' => 'boolean',
            'domain.customer.3.domain' => 'string',
            'domain.customer.3.weight' => 'integer',
            'domain.customer.3.is_year' => 'boolean',
            'domain.customer.3.is_notification' => 'boolean',
            'domain.customer.4.domain' => 'string',
            'domain.customer.4.weight' => 'integer',
            'domain.customer.4.is_year' => 'boolean',
            'domain.customer.4.is_notification' => 'boolean',
            'filesystem.default' => 'string',
            'filesystem.disks.local.driver' => 'string',
            'filesystem.disks.local.root' => 'string',
            'filesystem.disks.public.driver' => 'string',
            'filesystem.disks.public.root' => 'string',
            'filesystem.disks.public.url' => 'string',
            'filesystem.disks.public.visibility' => 'string',
            'filesystem.disks.s3.driver' => 'string',
            'filesystem.disks.s3.key' => 'NULL',
            'filesystem.disks.s3.secret' => 'NULL',
            'filesystem.disks.s3.region' => 'NULL',
            'filesystem.disks.s3.bucket' => 'NULL',
            'filesystem.disks.s3.url' => 'NULL',
            'filesystem.disks.s3.endpoint' => 'NULL',
            'filesystem.links./var/www/html/php/public/storage' => 'string',
            'lang.default_lang' => 'string',
            'lang.allow_lang_list' => 'array',
            'lang.detect_var' => 'string',
            'lang.use_cookie' => 'boolean',
            'lang.cookie_var' => 'string',
            'lang.header_var' => 'string',
            'lang.extend_list' => 'array',
            'lang.accept_language.zh-hans-cn' => 'string',
            'lang.allow_group' => 'boolean',
            'middleware.alias' => 'array',
            'middleware.priority' => 'array',
...
'cors.max_age','cors.supports_credentials','filesystems.default','filesystems.disks.local.driver','filesystems.disks.local.root',
...
'filesystems.disks.s3.endpoint','filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./var/www/html/php/public/storage',
...
'services.ses.secret','services.ses.region','services.slack.notifications.bot_user_oauth_token','services.slack.notifications.channel','app.name',
...
'app.aliases.RateLimiter','app.aliases.Redirect','app.aliases.Redis','app.aliases.Request','app.aliases.Response',
'app.aliases.Route','app.aliases.Schema','app.aliases.Session','app.aliases.Storage','app.aliases.Str',
'app.aliases.URL','app.aliases.Validator','app.aliases.View','cache.default','cache.stores.array.driver',
...
'captcha.length','captcha.codeSet','captcha.expire','captcha.useZh','captcha.math',
'captcha.useImgBg','captcha.fontSize','captcha.useCurve','captcha.useNoise','captcha.fontttf',
'captcha.bg','captcha.imageH','captcha.imageW','console.commands.dke','cookie.expire',
'cookie.path','cookie.domain','cookie.secure','cookie.httponly','cookie.setcookie',
'cookie.samesite','database.default','database.connections.sqlite.driver','database.connections.sqlite.url','database.connections.sqlite.database',
...
'database.redis.cache.host','database.redis.cache.password','database.redis.cache.port','database.redis.cache.database','domain.me.0.domain',
'domain.me.0.weight','domain.me.0.is_notification','domain.me.1.domain','domain.me.1.weight','domain.me.1.is_notification',
'domain.me.2.domain','domain.me.2.weight','domain.me.2.is_notification','domain.me.3.domain','domain.me.3.weight',
'domain.me.3.is_notification','domain.customer.0.domain','domain.customer.0.weight','domain.customer.0.is_year','domain.customer.0.is_notification',
'domain.customer.1.domain','domain.customer.1.weight','domain.customer.1.is_year','domain.customer.1.is_notification','domain.customer.2.domain',
'domain.customer.2.weight','domain.customer.2.is_year','domain.customer.2.is_notification','domain.customer.3.domain','domain.customer.3.weight',
'domain.customer.3.is_year','domain.customer.3.is_notification','domain.customer.4.domain','domain.customer.4.weight','domain.customer.4.is_year',
'domain.customer.4.is_notification','filesystem.default','filesystem.disks.local.driver','filesystem.disks.local.root','filesystem.disks.public.driver',
'filesystem.disks.public.root','filesystem.disks.public.url','filesystem.disks.public.visibility','filesystem.disks.s3.driver','filesystem.disks.s3.key',
'filesystem.disks.s3.secret','filesystem.disks.s3.region','filesystem.disks.s3.bucket','filesystem.disks.s3.url','filesystem.disks.s3.endpoint',
'filesystem.links./var/www/html/php/public/storage','lang.default_lang','lang.allow_lang_list','lang.detect_var','lang.use_cookie',
'lang.cookie_var','lang.header_var','lang.extend_list','lang.accept_language.zh-hans-cn','lang.allow_group',
'middleware.alias','middleware.priority','session.driver','session.lifetime','session.expire_on_close',
...
'verified','request.params','login.log',);
...
'APP_URL','LOG_CHANNEL','LOG_STACK','LOG_DEPRECATIONS_CHANNEL','LOG_LEVEL',
'DB_CONNECTION','DB_HOST','DB_PORT','DB_DATABASE','DB_USERNAME',
'DB_PASSWORD','DB_PREFIX','DB_CHARSET','DB_COLLATION','REDIS_CLIENT',
'REDIS_CLUSTER','REDIS_HOST','REDIS_PASSWORD','REDIS_PORT','REDIS_DB',
'REDIS_CACHE_DB','REDIS_SELECT','SESSION_DRIVER','SESSION_LIFETIME','CACHE_DRIVER',
'CACHE_PREFIX','MAIL_MAILER','MAIL_HOST','MAIL_PORT','MAIL_USERNAME',
'MAIL_PASSWORD','MAIL_ENCRYPTION','MAIL_FROM_ADDRESS','MAIL_FROM_NAME','BROADCAST_DRIVER',
'QUEUE_CONNECTION','FILESYSTEM_DISK','DEFAULT_LANG',);
