        ...
        <div className={styles.panel}>
          <div className={styles.panelInner}>
            <div className={styles.header}>
              <div className={styles.title}>管理后台</div>
              <div className={styles.subtitle}>平台管理员专用登录</div>
            </div>
            ...
            <Form form={form} onFinish={handleLogin} size="large" layout="vertical" requiredMark={false}>
              <Form.Item name="username" rules={[{ required: true, message: '请输入用户名' }]}>
                <Input prefix={<UserOutlined className={styles.prefixIcon} />} placeholder="用户名" />
              </Form.Item>
              ...
              <Form.Item name="captcha_code" rules={[{ required: true, message: '请输入验证码' }]}>
                <Input
                  ...
                  placeholder="图片验证码"
                  suffix={
                    <img title="点击刷新" onClick={fetchCaptcha}
                      style={{ width: 90, height: 36, cursor: 'pointer', objectFit: 'contain' }}
